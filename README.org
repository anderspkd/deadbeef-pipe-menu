...
* Screenshots
  ...
  If DeadBeef is running but no song is currently playing (i.e., stopped),
  the title displayed will be ~[cricket sounds]~. Can be changed by changing
  the string returned on line 22.
